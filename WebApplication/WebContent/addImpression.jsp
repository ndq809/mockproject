...
<body>
	...
	<div style="margin-top: 20px;"
		...
		<div class="col-lg-12" id="leftdiv">
			<s:form action="add-impression" method="post">
				...
				<div class="col-lg-12" style="margin-bottom: 20px">
					<textarea rows="4" class="form-control" name="impression.impressionName"></textarea>
				</div>
				<input type="submit" value="送信" class="btn btn-success col-lg-12" />

			</s:form>
			<a class="btn btn-default col-lg-3" style="margin: 20px 0px;"
				href="show-list-impression.action?bookId=${bookId }">戻る</a>
		</div>
