(function(a) {
	...
	a.fn.wtRotator = function(B) {
		...
		function A(bb, a8) {
			var ai = e(a8.width, 678);
			var a3 = e(a8.height, 300);
			...
			this.init = function() {
				...
				E.css({
					top : Math.round((a3 - E.outerHeight()) / 2),
					left : Math.round((ai - E.outerWidth()) / 2)
				}).show();
				aA();
				aN();
				aH();
				a7();
				ap();
				Q = new d(this, ai, a3, e(a8.vert_size, 50), bc, am, e(
						a8.vstripe_delay, 75));
				aB = new t(this, ai, a3, e(a8.horz_size, 50), bc, am, e(
						a8.hstripe_delay, 75));
				aK = new l(this, ai, a3, e(a8.block_size, 75), bc, am, e(
						a8.block_delay, 25));
				aS(0);
				av(ak)
			};
						...
						.each(function(be) {
							...
							a(this)
									.data(
											{
												imgurl : bd.attr("href"),
												caption : bd.attr("title"),
												effect : k[a(this).attr(
														"effect")] != undefined ? k[a(
														this).attr("effect")]
														: k[ah],
												delay : e(
														a(this).attr("delay"),
			...
			var a1 = function() {
				if (ar) {
					...
					for (var bd = 0; bd < au.length; bd++) {
						...
						if (bc != "") {
							au[bd].mouseover(a5).mouseout(aC).bind("mousemove",
									T)
						}
					}
				}
			...
			var a5 = function(bc) {
				var bd = L.data("bottom") ? L.data("yOffset") : -(L
						.outerHeight() + L.data("yOffset"));
			...
			var aT = function(bc) {
				...
				bc.attr("id", "curr-img").css("z-index", 1).stop(true, true)
						.fadeIn(am, function() {
			...
			this.showDButtons = function(bc) {
				...
				if (ax) {
					...
					aV.show();
					if (aw) {
						J.width(R.outerWidth(true) + P.outerWidth(true)
								+ aV.outerWidth(true))
					} else {
			...
			this.setTooltip = function(bc) {
				...
				if (ar) {
					...
					Z.unbind("mouseover", a5).unbind("mousemove", T).unbind(
							"mouseout", aC)
				}
			};
			...
			this.updateCPanel = function(bc) {
				...
				case y:
					...
					break;
				case w:
					aR(0, Math.floor((ai - I.outerWidth(true)) / 2), -I
							.outerHeight(true), "right");
					S.css("top", a3 - S.height());
					L.data({
						bottom : true,
						yOffset : 23
					...
					break;
				case f:
					aR(0, ai - I.outerWidth(true), -I.outerHeight(true),
							"right");
					S.css("top", a3 - S.height());
					L.data({
						bottom : true,
				...
				case u:
					...
					break;
				case n:
					aR(a3 - I.outerHeight(true), Math.floor((ai - I
							.outerWidth(true)) / 2), a3, "right");
					S.css("top", 0);
					L.data({
						bottom : false,
						yOffset : 5
					...
					break;
				default:
					aR(a3 - I.outerHeight(true), ai - I.outerWidth(true), a3,
							"right");
					S.css("top", 0);
					L.data({
						bottom : false,
